...
export const AppHeader: FC = () => {
  ...
  const isConstructor: boolean = (matchRoutes([{ path: '/' }], pathname) != null) && true
  const isProfile: boolean = (matchRoutes([{ path: '/profile' }, { path: '/login' }, { path: '/profile/orders' }], pathname) != null) && true
